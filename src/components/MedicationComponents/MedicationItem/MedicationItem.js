...
function MedicationItem(props) {
	...
	const medicationDose = props.dosage;
	const medicationDate = date.toLocaleString("en-US", {
		weekday: "long",
		month: "long",
		day: "numeric",
		year: "numeric",
	});
	const medicationTime = date.toLocaleString("en-US", {
		hour: "numeric",
		minute: "numeric",
		hour12: true,
	});
	...
	return (
		<Card className="medication-item">
			<div className="medication-info">
				<h1 className="medication-name"> {medicationName} : {medicationDose}mg</h1>
				<div className="date-container">
					<span className="last-taken">
						{" "}
						Last dose was taken on:{" "}
					</span>
			...
			<button className="dose-btn" onClick={updateDateHandler}>
				{" "}
				Take Medication{" "}
			</button>
		</Card>
